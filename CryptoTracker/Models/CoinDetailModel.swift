...
//JSON Coind detail response from API: https://api.coingecko.com/api/v3/coins/bitcoin
...
/*{
  ...
  "watchlist_portfolio_users": 1750487,
  "market_cap_rank": 1,
  "status_updates": [],
  "last_updated": "2024-11-21T09:12:31.003Z"
}*/

struct CoinDetailModel: Decodable {
    let coinId, symbol, name: String
